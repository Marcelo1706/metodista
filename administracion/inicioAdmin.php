    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="administradores">
          <a class="dropdown-item" href="addAdmin">Agregar un Administrador</a>
          <a class="dropdown-item" href="gestAdmin">Gestionar Administradores</a>
        </div>
      </li>
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="grados">
          <a class="dropdown-item" href="addGrado">Agregar un grado</a>
          <a class="dropdown-item" href="addSeccion">Agregar una sección</a>
          <a class="dropdown-item" href="gestGrado">Administrar grados</a>
          <a class="dropdown-item" href="gestSeccion">Administrar secciones</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="verSeccion">Ver Notas Por Sección</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="addLectivo">Añadir Año Lectivo</a>
        </div>
      </li>
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="docentes">
          <a class="dropdown-item" href="addDocente">Agregar un docente</a>
          <a class="dropdown-item" href="gestDocente">Gestionar docentes</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="asigSeccion">Asignar Secciones</a>
        </div>
      </li>
      <li class="nav-item dropdown active">
